...
#include "tflite-model/tflite_learn_840223_110.h"
#include "edge-impulse-sdk/classifier/ei_model_types.h"
#include "edge-impulse-sdk/classifier/inferencing_engines/engines.h"
#include "edge-impulse-sdk/classifier/postprocessing/ei_postprocessing_common.h"

const char* ei_classifier_inferencing_categories_840223_4[] = { "Leak", "No_leak" };

EI_CLASSIFIER_DSP_AXES_INDEX_TYPE ei_dsp_config_840223_76_axes[] = { 0 };
const uint32_t ei_dsp_config_840223_76_axes_size = 1;
ei_dsp_config_spectral_analysis_t ei_dsp_config_840223_76 = {
    76, // uint32_t blockId
...
const uint8_t ei_dsp_blocks_840223_4_size = 1;
ei_model_dsp_t ei_dsp_blocks_840223_4[ei_dsp_blocks_840223_4_size] = {
    { // DSP block 76
        76,
        98, // output size
        &extract_spectral_analysis_features, // DSP function pointer
        (void*)&ei_dsp_config_840223_76, // pointer to config struct
        ei_dsp_config_840223_76_axes, // array of offsets into the input stream, one for each axis
        ei_dsp_config_840223_76_axes_size, // number of axes
        1, // version
        nullptr, // factory function
        &ei_data_normalization_config_840223_76, // data normalization config
    }
};
const ei_config_tflite_graph_t ei_config_graph_840223_110 = {
    .implementation_version = 1,
    .model = tflite_learn_840223_110,
    .model_size = tflite_learn_840223_110_len,
    .arena_size = tflite_learn_840223_110_arena_size
};

const uint8_t ei_output_tensors_indices_840223_110[1] = { 0 };
const uint8_t ei_output_tensors_size_840223_110 = 1;
ei_learning_block_config_tflite_graph_t ei_learning_block_config_840223_110 = {
    .implementation_version = 1,
    .block_id = 110,
    .output_tensors_indices = ei_output_tensors_indices_840223_110,
    .output_tensors_size = ei_output_tensors_size_840223_110,
    .quantized = 0,
    .compiled = 0,
    .graph_config = (void*)&ei_config_graph_840223_110,
    .dequantize_output = 0,
};

const uint8_t ei_learning_blocks_840223_4_size = 1;
const uint32_t ei_learning_block_840223_110_inputs[1] = { 76 };
const uint8_t ei_learning_block_840223_110_inputs_size = 1;
const ei_learning_block_t ei_learning_blocks_840223_4[ei_learning_blocks_840223_4_size] = {
    {
        110,
        &run_nn_inference,
        (void*)&ei_learning_block_config_840223_110,
        EI_CLASSIFIER_IMAGE_SCALING_NONE,
        ei_learning_block_840223_110_inputs,
        ei_learning_block_840223_110_inputs_size,
    },
};

const size_t ei_postprocessing_blocks_840223_4_size = 1;
const ei_postprocessing_block_t ei_postprocessing_blocks_840223_4[ei_postprocessing_blocks_840223_4_size] = {
    {
        .block_id = 110,
...
const uint8_t freeform_outputs_840223_4_size = 0;

uint32_t *freeform_outputs_840223_4 = nullptr;

const ei_impulse_t impulse_840223_4 = {
    .project_id = 840223,
    .project_owner = "Suporte",
    .project_name = "Sane.AI.Final",
    .impulse_id = 4,
    ...
    .dsp_blocks_size = ei_dsp_blocks_840223_4_size,
    .dsp_blocks = ei_dsp_blocks_840223_4,

    .learning_blocks_size = ei_learning_blocks_840223_4_size,
    .learning_blocks = ei_learning_blocks_840223_4,

    .postprocessing_blocks_size = ei_postprocessing_blocks_840223_4_size,
    .postprocessing_blocks = ei_postprocessing_blocks_840223_4,
    ...
    .label_count = 2,
    .categories = ei_classifier_inferencing_categories_840223_4,
    .results_type = EI_CLASSIFIER_TYPE_CLASSIFICATION,
    .freeform_outputs_size = freeform_outputs_840223_4_size,
    .freeform_outputs = freeform_outputs_840223_4
};

ei_impulse_handle_t impulse_handle_840223_4 = ei_impulse_handle_t( &impulse_840223_4 );

ei_impulse_handle_t& ei_default_impulse = impulse_handle_840223_4;
constexpr auto& ei_classifier_inferencing_categories = ei_classifier_inferencing_categories_840223_4;
const auto ei_dsp_blocks_size = ei_dsp_blocks_840223_4_size;
ei_model_dsp_t *ei_dsp_blocks = ei_dsp_blocks_840223_4;
