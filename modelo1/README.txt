...
# Edge Impulse library for Sane.AI.MFE

This is a C++ library that lets you run the impulse for "Sane.AI.MFE" (https://studio.edgeimpulse.com/studio/840911) on any device. It consists of the Edge Impulse inferencing SDK - with implementations of both processing and learning blocks - and your model. You will need to include this library in your project to run your impulse locally.
